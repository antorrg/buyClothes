...
export default {
  ...
  productCreate2 :[{name: "order", type: "string"}, {name: "characteristics", type: "string"}, {name: "price", type: "float"}, {name: "stock", type: "int"}, {name: "images", type: "array"},{name: "size", type: "string"}, {name: "color", type: "string"},],
